    ...
    <BrowserRouter>
      <AlertContext.Provider value={createAlert}>
        <Routes>
          ...
          <Route path="game/:gameId/question/:questionId" element={<PrivateRoute>
            <EditQuestionScreen />
          </PrivateRoute>}/>
          <Route path="game/:gameId" element={<PrivateRoute>
            <EditGameScreen />
          </PrivateRoute>}/>
          <Route path="session/:sessionId" element={<PrivateRoute>
            <ManageSessionScreen />
          </PrivateRoute>}/>
          <Route path="session/:sessionId/results" element={<PrivateRoute>
            <ResultsScreen />
          </PrivateRoute>}/>
