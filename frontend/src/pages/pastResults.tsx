                ...
                {pastSessionData.map((session) => {
                  return (
                    <div key={session.pastSessionId}>
                      <a className="text-black hover:underline hover:text-pink-400 cursor-pointer" onClick={() => navigate(`/session/${session.pastSessionId}/results`)}>
                        View session{session.pastSessionId}
                        {' '}
                        results
                      </a>
                    </div>
