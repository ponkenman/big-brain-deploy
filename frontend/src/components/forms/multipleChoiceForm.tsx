...
export default function MultipleChoiceForm(props: {question: Question, index: number, questions: Question[], onEnter?: () => void; set: StateSetter<Question[]> }) {
  ...
  return (<>
    ...
    {props.questions[props.index].answers.length < 6 && (
