 ...
 */
export default function IconButton(props: { className: string, svg: string, onClick: () => void, alt: string, ariaLabel: string }) {
  return (<button aria-label={props.ariaLabel} className={`cursor-pointer ${props.className}`} onClick={props.onClick}>
